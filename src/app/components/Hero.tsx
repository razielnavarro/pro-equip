const HeroSection = () => {
  return (
    <div className="relative min-h-[600px] h-[50vh] xl:h-screen w-full overflow-visible z-20 flex justify-center items-center xl:items-start">
      ...
      <div className="absolute top-[15%] sm:top-[10%] md:top-[6%] lg:top-[8%] xl:top-[50%] left-1/2 -translate-x-1/2 md:left-1/2 md:-translate-x-1/2 xl:left-auto xl:right-10 xl:translate-x-0 xl:transform xl:-translate-y-1/2 z-15 w-[300px] sm:w-[340px] md:w-[400px] xl:w-auto">
        <img
